//+------------------------------------------------------------------+
//| GoldReport.mq5 v3.0 - ULTIMATE Edition + Symbol Data Export     |
//| Snapshot-based Trading Report Bot + Symbol Data Export          |
//| Part of the Goldjunge Trading System                            |
//| TIMING FIX: Goldjunge-Style Timer Logic (NO Init-Export!)       |
//+------------------------------------------------------------------+
#property copyright "Shinpai-AI"
#property link      "https://github.com/Shinpai-AI"
#property version   "3.00"
#property description "Snapshot-based Trading Reports + Symbol Data Export - Goldjunge Style!"

//+------------------------------------------------------------------+
//| Enums - Goldjunge Style                                         |
//+------------------------------------------------------------------+
enum ENUM_INTERVAL {
   INTERVAL_OFF = 0,     // Aus
...
input ENUM_INTERVAL ReportInterval = INTERVAL_7_DAYS;  // Report Interval (Goldjunge Style)
...
// Helper function - From Goldjunge.mq5
...
string GetAssetType(string symbol) {
   ...
   if (StringFind(symbol, "BTC") >= 0 || StringFind(symbol, "ETH") >= 0 || 
       ...
       StringFind(symbol, "ADA") >= 0 || StringFind(symbol, "LTC") >= 0 ||
       StringFind(symbol, "DOGE") >= 0 || StringFind(symbol, "AVAX") >= 0 ||
       StringFind(symbol, "LINK") >= 0 || StringFind(symbol, "DOT") >= 0) {
      return "CRYPTO";
   }
   // Metals
   ...
   // Commodities
   else if (StringFind(symbol, "USO") >= 0 || StringFind(symbol, "UKO") >= 0 ||
            StringFind(symbol, "OIL") >= 0 || StringFind(symbol, "BRENT") >= 0 ||
            StringFind(symbol, "WTI") >= 0 || StringFind(symbol, "CRUDE") >= 0) {
      return "COMMODITY";
   }
   // Indices
   ...
   // Stocks
   else if (StringFind(symbol, "AAPL") >= 0 || StringFind(symbol, "MSFT") >= 0 ||
            StringFind(symbol, "GOOGL") >= 0 || StringFind(symbol, "AMZN") >= 0 ||
            StringFind(symbol, "TSLA") >= 0 || StringLen(symbol) <= 5) {
      return "STOCK";
   }
   // Default: Forex
   else {
...
string GetQuoteCurrency(string symbol) {
   ...
   // Crypto pairs
   else if (StringFind(symbol, "USD") > 0) return "USD";
   else if (StringFind(symbol, "EUR") > 0) return "EUR";
   else if (StringFind(symbol, "GBP") > 0) return "GBP";
   else if (StringFind(symbol, "JPY") > 0) return "JPY";
   else if (StringFind(symbol, "CHF") > 0) return "CHF";
   else if (StringFind(symbol, "CAD") > 0) return "CAD";
   else if (StringFind(symbol, "AUD") > 0) return "AUD";
   else if (StringFind(symbol, "NZD") > 0) return "NZD";
   else return "USD"; // Default fallback
}
...
string GetBaseCurrency(string symbol) {
   ...
   // Crypto and others
   else if (StringFind(symbol, "BTC") >= 0) return "BTC";
   else if (StringFind(symbol, "ETH") >= 0) return "ETH";
   else if (StringFind(symbol, "XRP") >= 0) return "XRP";
   else if (StringFind(symbol, "SOL") >= 0) return "SOL";
   else if (StringFind(symbol, "ADA") >= 0) return "ADA";
   else if (StringFind(symbol, "LTC") >= 0) return "LTC";
   else if (StringFind(symbol, "XAU") >= 0) return "XAU";
   else if (StringFind(symbol, "XAG") >= 0) return "XAG";
   else if (StringFind(symbol, "XPD") >= 0) return "XPD";
   else if (StringFind(symbol, "XPT") >= 0) return "XPT";
   else if (StringFind(symbol, "USO") >= 0) return "USO";
   else if (StringFind(symbol, "UKO") >= 0) return "UKO";
   else return StringSubstr(symbol, 0, 3); // Fallback
}
...
int OnInit()
{
    ...
    Print("📸 Goldjunge-Style Timer Logic - NO Init Timer!");
...
//+------------------------------------------------------------------+
//| Helper Functions - Goldjunge Style                              |
//+------------------------------------------------------------------+
